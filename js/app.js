 ...
 */
    ...
    (() => {
        ...
        function addLoadedClass() {
            window.addEventListener("load", (function() {
                ...
                links.forEach((function(link) {
                    function checkLink() {
                        if (!/^#/.test(link.getAttribute("href")) && !/^tel:/.test(link.getAttribute("href")) && !/^mailto:/.test(link.getAttribute("href"))) if (link.href.indexOf(window.location.href) < 0) link.addEventListener("click", onLinkClicked);
                    }
        ...
        function menuOpen(menu, openClass, focusClasss) {
            bodyLock();
        ...
        function menuClose(menu, openClass, focusClasss) {
            ...
            if (document.querySelector(".icon-menu")) {
                ...
                document.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".icon-menu")) {
                        bodyLockToggle();
                        if (!document.documentElement.classList.contains("menu-open")) menuOpen(menu, "menu-open", ".more-menu__close-btn"); else menuClose(menu, "menu-open", ".menu__icon.icon-menu");
                    }
                    if (bodyLockStatus && !e.target.closest(".more-menu") && document.documentElement.classList.contains("menu-open")) menuClose(menu, "menu-open", ".menu__icon.icon-menu");
                }));
            }
        }
        function accountMenuInit() {
            if (document.querySelector(".icon-account-menu")) {
                ...
                document.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".icon-account-menu")) {
                        bodyLockToggle();
                        if (!document.documentElement.classList.contains("account-menu-open")) menuOpen(menu, "account-menu-open", ".account-menu__close-btn"); else {
                            bodyUnlock();
        ...
        //!!! Для демонстрации
            ...
            if (document.querySelector(".icon-log-in-menu")) {
                ...
                if (menu) menu.style.display = "none";
                document.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".icon-log-in-menu")) if (!document.documentElement.classList.contains("log-in-menu-open")) {
                        ...
                        setTimeout((() => {
                            ...
                            if (messageMenu && messageMenu.style.display !== "none") menuClose(messageMenu, "message-menu-open", ".log-in-menu__close-btn");
                        }), 500);
                    } else {
                        bodyUnlock();
        ...
        function forgotMenuInit() {
            if (document.querySelector(".icon-forgot-menu")) {
                const menu = document.querySelector(".forgot-menu");
                if (menu) menu.style.display = "none";
                document.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".icon-forgot-menu")) if (!document.documentElement.classList.contains("forgot-menu-open")) {
        ...
        function messageMenuInit() {
            if (document.querySelector(".message-menu__button")) {
                ...
                if (menu) menu.style.display = "none";
                document.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".message-button-menu")) if (document.documentElement.classList.contains("message-menu-open")) {
                        bodyUnlock();
        ...
        function filterInit() {
            ...
            if (filter) {
                function handleViewportChange(mq) {
                    if (mq.matches) filter.style.display = "none"; else filter.removeAttribute("style");
                }
                ...
                document.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".filter-btn")) if (!document.documentElement.classList.contains("filter-open")) menuOpen(filter, "filter-open", ".filter__button-close"); else {
                        bodyUnlock();
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                } else if (formRequiredItem.dataset.required === "tel") if (formRequiredItem.inputmask.unmaskedvalue().length < 9) {
                    this.addError(formRequiredItem);
                    error++;
                } else this.removeError(formRequiredItem); else if (formRequiredItem.dataset.required === "password") if (formRequiredItem.closest("form").querySelector('[data-password="new"]').value !== formRequiredItem.value || formRequiredItem.value.length < 5) {
                    this.addError(formRequiredItem);
                    error++;
        ...
        if (inputMasks.length) flsModules.inputmask = Inputmask("+375 (99) 999-99-99").mask(inputMasks);
        var PipsMode;
        (function(PipsMode) {
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                item.noUiSlider.on("update", (function(values, handle) {
                    ...
                    if (handle) toValue.value = value; else fromValue.value = value;
                }));
        ...
        function initSliders() {
            ...
            if (document.querySelector(".bike-slider")) new Swiper(".bike-slider", {
                modules: [ freeMode ],
                observer: true,
                observeParents: true,
                autoHeight: false,
            ...
            if (document.querySelector(".about-gallery__slider")) new Swiper(".about-gallery__slider", {
...
***************************************************************************** */
        ...
        function initFilterResetBtn() {
            const filterResetBtn = document.querySelector(".filter__button-reset");
            const filter = document.querySelector(".filter");
            if (filterResetBtn && filter) filterResetBtn.addEventListener("click", (() => {
        ...
        function script_filterInit() {
            ...
            if (filter) {
                ...
                var breakpoint = "(max-width: 767.98px)";
        ...
        function popupQuickInit() {
            ...
            const products = document.querySelectorAll(".product");
            if (popup && products) products.forEach((product => {
                ...
                product.querySelector(".product-id");
        ...
        if (articleElement) articleElement.addEventListener("click", (function() {
        ...
        function favoriteInit() {
            ...
            const deleteProducts = productParent => {
                if (productParent) {
                    ...
                    if (favoriteList) favoriteList.querySelector(`.product[data-product-id="${id}"]`).remove();
                    const deletedProductCard = document.querySelector(`.product[data-product-id="${id}"]`);
                    if (deletedProductCard) deletedProductCard.querySelector(".favorite-button").dataset.selected = false;
                    removeObjectById(id);
                    printQuantity();
            ...
            function selecteButton(id) {
                ...
                if (selectedProductCards.length) selectedProductCards.forEach((card => {
                    card.querySelector(".favorite-button").dataset.selected = true;
                }));
                if (merchendiseFavoriteButton) merchendiseFavoriteButton.dataset.selected = true;
            }
            ...
            function generateFavoriteProduct(product) {
                ...
                function productVerification(copyProduct) {
                    if (copyProduct.status) return `<div class="product__status ${copyProduct.status.class}">${copyProduct.status.text}</div>`; else return "";
                }
                ...
                let disabled;
                if (cartItems.some((item => item.id === copyProduct.id))) disabled = "disabled"; else disabled = "";
            ...
            if (favoriteButton || document.querySelector(".account-favorites")) document.addEventListener("click", (function(e) {
                if (e.target.closest(".favorite-button")) {
                    ...
                    if (button.dataset.selected !== "true") {
                        ...
                        let country;
                        if (parent.querySelector(".product__country") !== null) country = {
                        ...
                        function statusCheck(parent) {
                            ...
                            if (status.classList.contains("_out-in-stock")) return "_out-in-stock"; else return "";
                        }
                        let status;
                        if (parent.querySelector(".product__status") !== null) status = {
                    ...
                    } else deleteProducts(button.closest(".product"));
                }
            }));
            if (merchendiseFavoriteButton) merchendiseFavoriteButton.addEventListener("click", (() => {
                if (merchendiseFavoriteButton.dataset.selected !== "true") {
                    ...
                    if (countryElem) if (countryElem.dataset !== null) country = {
                    ...
                    let status;
                    if (document.querySelector(".header-merchandise__status") !== null) status = {
        ...
        function cartInit() {
            ...
            function disabledButton(id) {
                ...
                if (disabledProductCards.length > 0) disabledProductCards.forEach((card => {
                    if (card) card.querySelector(".cart-button").disabled = true;
                }));
                if (merchendiseСartButton) {
                    let merchendiseId = document.getElementById("articleElement").textContent.replace("-", "");
                    if (id === merchendiseId) merchendiseСartButton.disabled = true;
                }
            }
            ...
            function addInputChange(item) {
                ...
                if (!quantityInput.onchange) quantityInput.addEventListener("change", (() => {
            ...
            if (cartList) cartItems.forEach((item => {
            ...
            function generateCartProduct(product) {
                let copyProduct = Object.assign({}, product);
                if (copyProduct.oldPrice === copyProduct.currentPrice) copyProduct.oldPrice = ""; else copyProduct.oldPrice = normalPrice(copyProduct.oldPrice);
                if (copyProduct.currentPrice === 0) copyProduct.currentPrice = ""; else copyProduct.currentPrice = normalPrice(copyProduct.currentPrice);
            ...
            const deleteProducts = productParent => {
                ...
                const deletedProductCard = document.querySelector(`.product[data-product-id="${id}"]`);
                if (deletedProductCard) deletedProductCard.querySelector(".cart-button").disabled = false;
                removeObjectById(id);
                updateCartItemsInLocalStorage();
                updateCart();
                productParent.remove();
            };
            if (cartButton || document.querySelector(".account-favorites")) document.addEventListener("click", (e => {
                let self = e.target;
                if (self.closest(".cart-button")) {
                    ...
                    let priceOldNumber;
                    if (priceOldString.length > 0) priceOldNumber = parseInt(priceOldString); else priceOldNumber = priceCurrentNumber;
                    let product = {
                        id: parent.dataset.productId,
            ...
            if (merchendiseСartButton) merchendiseСartButton.addEventListener("click", (() => {
            ...
            if (cleanCart && cartList) {
                ...
                cartList.addEventListener("click", (e => {
                    let targetElement = e.target;
                    if (targetElement.classList.contains("cart-product__delete-button")) deleteProducts(targetElement.closest(".content-cart__item"));
