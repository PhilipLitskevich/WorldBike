    ...
    (() => {
        ...
        function filterInit() {
            ...
            if (filter) {
                ...
                document.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".filter-btn")) if (!document.documentElement.classList.contains("filter-open")) menuOpen(filter, "filter-open", ".filter__button-close"); else menuClose(filter, "filter-open", ".catalog__filter-btn.filter-btn");
                    if (bodyLockStatus && !e.target.closest(".filter") && document.documentElement.classList.contains("filter-open")) menuClose(filter, "filter-open", ".catalog__filter-btn.filter-btn");
                }));
            }
        }
